...
-- ПЕРЕД ЗАПУСКОМ СКРИПТА УБЕДИТЕСЬ КАКОЕ ПОЛЕ В JSON ВАМ НАДО ПОМЕНЯТЬ, В КАКИХ-ТО НУЖНО МЕНЯТЬ PARENT_ID, В КАКИХ-ТО CHART_ID (в некоторых нужно менять t_tl_tpay_id )
...
--  возможно  придется апдейтить таблицу od_vorders
update od_vorders o
   set chart_id=636526
where o.CHART_ID = 197546
  and o.stype = 'сюда нужно поставить нужно значение в зависимости от того что мы переносим услуга, прием и тд'
  and o.id = 14676962
