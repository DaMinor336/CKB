select au.in_date date_time,
       ...
       (select nvl(o.shortname,o.fullname)
          from s_str_orgs o, s_sht_zaps z, s_sht_rasps r where z.s_sht_rasp_s_sht_rasp_id=r.s_sht_rasp_id
                                                           and r.s_str_org_s_str_org_id=o.s_str_org_id
                                                           and z.s_sht_zap_id = au.author_sht_zap_id) org_name,
       (select lower(nvl(a.shortname,a.fullname))
          from s_str_orgs o, s_sht_zaps z, s_sht_rasps r, s_appoints a where z.s_sht_rasp_s_sht_rasp_id=r.s_sht_rasp_id
                                                                         and r.s_str_org_s_str_org_id=o.s_str_org_id
